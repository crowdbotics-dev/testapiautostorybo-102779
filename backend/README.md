...
## Project Structure
    ...
    ├── testapiautostorybo_102779  # Django project configurations
...
1. Clone this repo and `cd testapiautostorybo_102779`
...
2. Clone this repo and `cd testapiautostorybo_102779`
